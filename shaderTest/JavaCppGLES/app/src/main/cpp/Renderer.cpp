...
// https://github.com/SaschaWillems/Vulkan/blob/master/examples/terraintessellation/terraintessellation.cpp
...
std::istream * Renderer::get_resource(const std::string &path)
{
...
bool Renderer::load_file(const std::string& filename, std::string& str)
{
