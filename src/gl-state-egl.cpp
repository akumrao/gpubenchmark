...
#ifdef GPULOAD_USE_X11
#define GPULOAD_NATIVE_EGL_DISPLAY_ENUM EGL_PLATFORM_X11_KHR
#elif  GPULOAD_USE_WAYLAND
#define GPULOAD_NATIVE_EGL_DISPLAY_ENUM EGL_PLATFORM_WAYLAND_KHR
#elif  GPULOAD_USE_DRM
#define GPULOAD_NATIVE_EGL_DISPLAY_ENUM EGL_PLATFORM_GBM_KHR
#elif  GPULOAD_USE_MIR
#define GPULOAD_NATIVE_EGL_DISPLAY_ENUM EGL_PLATFORM_MIR_KHR
#else
// Platforms not in the above platform enums fall back to eglGetDisplay.
#define GPULOAD_NATIVE_EGL_DISPLAY_ENUM 0
#endif
...
GLStateEGL::gotValidDisplay()
{
    ...
    if (GPULOAD_NATIVE_EGL_DISPLAY_ENUM != 0 && supported_extensions
        && strstr(supported_extensions, "EGL_EXT_platform_base"))
    {
        ...
        if (egl_get_platform_display != nullptr) {
            egl_display_ = egl_get_platform_display(
                GPULOAD_NATIVE_EGL_DISPLAY_ENUM,
