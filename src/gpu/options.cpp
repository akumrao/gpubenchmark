...
std::string Options::data_path = std::string(GPULOAD_DATA_PATH);
...
Options::print_help()
{
    printf("A benchmark for Open GL (ES) 2.0\n"
           ...
           "      --data-path PATH   Path to gpuload models, shaders and textures\n"
           "                         Default: " GPULOAD_DATA_PATH "\n"
           ...
           "                         (same as -b :show-stats=true:title=#info#)\n"
